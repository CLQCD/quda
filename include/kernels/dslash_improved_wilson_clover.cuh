...
namespace quda
{
  ...
  struct ImprovedWilsonCloverArg : ImprovedWilsonArg<Float, nColor, nDim, reconstruct_> {
    ...
    ImprovedWilsonCloverArg(ColorSpinorField &out, const ColorSpinorField &in, const GaugeField &U, const GaugeField &L,
                    const CloverField &A, double a, double b, const ColorSpinorField &x, double improve, int parity, bool dagger,
  ...
  struct improvedWilsonClover : dslash_default {

    const Arg &arg;
    constexpr improvedWilsonClover(const Arg &arg) : arg(arg) {}

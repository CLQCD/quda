...
namespace quda
{
  ...
  struct ImprovedWilsonCloverArg : ImprovedWilsonArg<Float, nColor, nDim, reconstruct_> {
    using ImprovedWilsonArg<Float, nColor, nDim, reconstruct_>::nSpin;
    ...
    ImprovedWilsonCloverArg(ColorSpinorField &out, const ColorSpinorField &in, const GaugeField &U, const GaugeField &L,
                            const CloverField &A, double a, const ColorSpinorField &x, double improve, int parity, bool dagger,
                            const int *comm_override) :
      ImprovedWilsonArg<Float, nColor, nDim, reconstruct_>(out, in, U, L, a, x, improve, parity, dagger, comm_override),
  ...
  struct improvedWilsonCloverPreconditioned : dslash_default {

    const Arg &arg;
    constexpr improvedWilsonCloverPreconditioned(const Arg &arg) : arg(arg) {}
    ...
    */
    ...
    __device__ __host__ __forceinline__ void operator()(int idx, int, int parity)
    {
      ...
      applyImprovedWilson<nParity, dagger, mykernel_type>(out, arg, coord, parity, idx, thread_dim, active);
